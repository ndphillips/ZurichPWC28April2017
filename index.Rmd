...
plot(heart.fft, 
     main = "Heart Disease FFT", 
     decision.names = c("Low Risk", "High Risk"), stats = FALSE)
```

--- 


```{r, eval = TRUE, fig.align = 'center', echo = FALSE ,message = FALSE, dpi = 200, out.width = "65%", fig.width = 8, fig.height = 7, echo = TRUE}
...
```{r , fig.margin = TRUE, echo = FALSE, out.width = "90%", fig.align='center'}
knitr::include_graphics(c("images/collaboratos.png"))
```
